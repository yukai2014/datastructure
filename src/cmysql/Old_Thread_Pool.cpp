...
void Thread_Pool::Thread_Pool_add(void (*function_)(void *), void *argument_){
	int next_task_todo=0;	// next_task_todo variable is useless	--Yu
...
void *Thread_Pool::threadpool_thread(void *arg){
	...
	while(1){
		//this lock will affect the degree of parallelism	--Yu
